    ...
    properties.forEach(p => {
      const card = `
        <article class="popular-card swiper-slide">
          <img src="./assets/img/${p.image_url}" class="popular-img">
          <div class="popular-data">
            <h2 class="popular-price"><span>₹</span>${p.price}</h2>
            <h3 class="popular-title">${p.title}</h3>
            <p class="popular-description">${p.location}</p>
          </div>
        </article>
      `;
